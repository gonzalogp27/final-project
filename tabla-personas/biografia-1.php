...
?>
    <form action="biografia-2.php" method="post">
        <p>Select the artist whose biography you want to read:</p>
...
<?php
        ...
        print "\n";
        print "  <p>\n";
        print "   <input type=\"submit\" value=\"Read biography\">\n";
