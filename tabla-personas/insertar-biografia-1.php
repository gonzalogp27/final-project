...
?>
    <p>Select the artist whose biography you want to edit:</p>
    <form action="insertar-biografia-2.php" method="post">
...
<?php
        foreach ($resultado as $registro) {
            ...
            print "   <td>$registro[biografia]</td>\n";
        ...
        print "\n";
        print "  <p>\n";
        print "   <input type='submit' value='Modify biography'>\n";
